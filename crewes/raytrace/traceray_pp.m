function [t,p,L]=traceray_pp(vp,zp,zs,zr,zd,x,xcap,pfan,itermax,optflag,pflag,dflag)
% TRACERAY_PP: traces a P-P (or S-S) reflection for v(z)
%
% [t,p,L]=traceray_pp(vp,zp,zs,zr,zd,x,xcap,pfan,itermax,optflag,pflag,dflag)
%
