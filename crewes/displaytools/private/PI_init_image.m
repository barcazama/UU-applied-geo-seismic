...
if(sv==1)
    ...
    'CLIP','GRAY_PCT','NUMBER_OF_COLORS','SCALE_OPT');
end
...
hzoompick=uicontrol('style','popupmenu',...
    'string','Zoom|Pick(O)|AdvancedPick(0)|Pick(N)',...
...
set(gcf,'userdata',[hflip hmsgmain -1 hmsg hi hscale hclip -1 ,...
        hzoompick hmaster hlabel hslider hclip hlimbox hfile2 hvrtscrol hhorscrol]);
